	  		...
	  		<div className="container" id="about">
	  			<h3>About Me </h3>
  					<p>
  						...
  						Through my previous internships and school courses, I have gained experience developing in Java, Golang, C++, C, and Bash. Most recently, I have just completed an internship as a Software Developer at Altairix where I developed a custom reporting feature for their newly created questionnaire. These reports are generated on a weekly basis and help the organization and their clients understand the demographics of the questionnaire in order to create highly targeted marketing campaigns.

  						My other experiences include working as a Security Engineer at League Inc. where I was responsible for protecting the integrity of the League application. As a result, I developed the authentication flow for users signing into the app as well as investigated and presented new security applications to be used by the entire engineering team. Prior to League, I was a Security Software Developer on an innovation team at BlackBerry that was responsible for investigating new ideas for the organization. One of my main projects throughout the term was to develop a prototype of an Android application that emulates a car key using Bluetooth on your phone. Before BlackBerry, I was a Quality Engineering Intern at Interset, where I was responsible for automating the product installer using Bash, developing unit tests in Java, and performing regression tests on the latest product release. Additionally, in the winter of 2018, I worked at the Public Service Commission of Canada (PSC) as an IT Security Analyst. My role at the PSC was to prevent, manage, and mitigate IT security incidents. I accomplished this by researching new security tools and creating a knowledge base on how to handle security incidents for future employees. <br/> <br/>
